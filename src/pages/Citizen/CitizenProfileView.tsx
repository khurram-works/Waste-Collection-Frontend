...
import { updatedCitizenProfile, updatedPassword } from "../../api/auth";
import { toast } from "react-toastify";
import { useNavigate } from "react-router-dom";
import { deleteCitizenAccount } from "../../api/auth";
...
const SectionHeader = ({
  ...
  <div className="flex items-start gap-4 mb-6">
    ...
    <div className="flex-1 min-w-0">
      <h3 className="text-[14px] font-bold text-[#111827] leading-tight tracking-[-0.01em]">
        {title}
      </h3>
      <p className="text-[12px] text-[#9ca3af] mt-0.5 leading-relaxed">{subtitle}</p>
    </div>
    <div className="h-px flex-1 bg-[#f3f4f6] self-center hidden sm:block" />
  </div>
);
...
const CitizenProfileView = () => {
  ...
  const onSubmit = async (data: PersonalInfoFormValues) => {
    try {
      await updatedCitizenProfile(data);
      ...
      <div className="max-w-245 mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[268px_1fr] gap-5 lg:gap-7 items-start">
          <div className="flex flex-col gap-4 lg:sticky lg:top-8">
              ...
              <div className="px-5 mt-7 pb-5">
                ...
                <div className="space-y-2.5">
                  {[
                    ...
                    { icon: "badge",      label: "Role",    val: "Citizen"                  },
                  ].map(({ icon, label, val }) => (
            ...
            <div
              className="bg-white rounded-2xl border border-[#e5e7eb] overflow-hidden"
              style={{ boxShadow: "0 1px_4px rgba(0,0,0,.04)" }}
            >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  { label: "Requests", val: "12", icon: "recycling", color: "#059669", bg: "#f0fdf4" },
                  { label: "Pickups",  val: "9",  icon: "local_shipping", color: "#0ea5e9", bg: "#f0f9ff" },
          ...
          >
            ...
            {activeTab === "info" && (
              <div className="px-6 md:px-8 py-7 space-y-5 animate-[fadeSlide_.2s_ease]">
                ...
                <Field label="Primary Pickup Address" error={errors.address?.message}>
                  <div
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 px-4 py-2.5 bg-[#f0fdf4] border-t border-[#d1fae5] mt-1">
                      ...
                      <span className="text-[10.5px] text-[#6ee7b7] font-medium leading-relaxed">
                        Used for scheduled waste collections and route planning
                      </span>
                    </div>
                  </div>
                </Field>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex gap-1.5 flex-1">
                        {[1, 2, 3, 4].map((b) => (
                          <div
                            key={b}
                            className="flex-1 h-1025 rounded-full bg-[#eeeeee] overflow-hidden"
                          >
                            <div
                              ...
                              style={{
                                ...
                                background:
                                  b <= strength.bars ? strength.color : "transparent",
                              }}
                            />
                          </div>
                        ))}
                    ...
                    <div className="flex items-start gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[12px] text-[#fb7185] mt-1 leading-relaxed max-w-[320px]">
                          Permanently removes your profile, pickup history, earnings, and all associated data.
                        </p>
                      </div>
                    </div>
                    <button
